            ...
            for i in self.data:
                if i.fk == 'GET':
                    ...
                    try:
                        ...
                        b = log_a.objects.create(user=uuid.uuid1(), name=i.name, username=i.user, data=str(a.json()),
                                                 time=datetime.datetime.now())

                    except:
                        print(a.text)
                        b = log_a.objects.create(user=uuid.uuid1(), name=i.name, username=i.user, data=str(a.text),
                                                 time=datetime.datetime.now())
